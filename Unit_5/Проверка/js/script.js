...
function t8() {
    ...
    let input1 = +document.querySelector('.input-8_one').value; // преобразование введенных значений в число
    let input2 = +document.querySelector('.input-8_two').value; // преобразование введенных значений в число
